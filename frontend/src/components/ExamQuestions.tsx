...
export const ExamQuestions = memo(function ExamQuestions() {
  ...
  // Estado para el sistema de paneles deslizantes
  const [activePanel, setActivePanel] = useState<'files' | 'text'>('files');

  // --- Handlers ---
  const handlePanelSwitch = (panel: 'files' | 'text') => {
        ...
        >
          ...
          <div className="card-content">
            ...
            <div className="sliding-panels-container">
              {/* Files Panel */}
              <div 
                className={`sliding-panel ${activePanel === 'files' ? 'primary' : 'secondary left'}`}
                ...
                <div className="panel-content">
                  <div className="panel-header">
                    <div className="flex items-center flex-1">
                      ...
                      >
                        <i 
                          className="fas fa-file-upload text-xl"
                          style={{ color: 'var(--theme-success)' }}
                        />
                      </div>
                      <div>
                        <h3 className="panel-title" style={{ color: 'var(--theme-text-primary)' }}>
                          Subir Archivos {files.length > 0 && `(${files.length})`}
                        </h3>
                        <p className="panel-subtitle" style={{ color: 'var(--theme-text-secondary)' }}>
                          PDFs, imágenes y documentos
                        </p>
                      </div>
                    </div>
                    
                    {/* Límites y Validaciones en el header */}
                    {activePanel === 'files' && (
                      <div 
                      ...
                      >
                        ...
                        <div className="space-y-1">
                          <div className="text-xs" style={{ color: 'var(--theme-warning-dark)' }}>
                            <strong>Archivos:</strong> Máx 20 archivos, 50 imágenes
                          </div>
                          <div className="text-xs" style={{ color: 'var(--theme-warning-dark)' }}>
                            <strong>Formatos:</strong> PDF, JPG, PNG, WEBP, TXT, MD
                          </div>
                        </div>
                      </div>
                    )}
              ...
              {/* Text Panel */}
              <div 
                className={`sliding-panel ${activePanel === 'text' ? 'primary' : 'secondary right'}`}
                onClick={() => handlePanelSwitch('text')}
              >
                <div className="panel-content">
                  <div className="panel-header">
                    <div 
                    ...
                    <div>
                      ...
                      <p className="panel-subtitle" style={{ color: 'var(--theme-text-secondary)' }}>
                        Artículos, notas de clase, documentos
                      </p>
                    </div>
                  </div>
